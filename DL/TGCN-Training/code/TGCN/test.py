...
if __name__ == '__main__':
    ...
    config_file = os.path.join(root, 'code/TGCN/archive/asl100/asl100.ini')
    ...
    model = GCN_muti_att(input_feature=num_samples * 2, hidden_feature=hidden_size,
                         num_class=int(trained_on[3:]), p_dropout=drop_p, num_stage=num_stages).to(torch.device)

    print('Loading model...')

    checkpoint = torch.load(os.path.join(root, 'code/TGCN/archive/asl100/ckpt.pth'))
